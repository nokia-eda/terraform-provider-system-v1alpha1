---
page_title: "system-v1alpha1 Provider"
---

# system-v1alpha1 Provider

This provider is used to interact with the resources provided by the **system-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
