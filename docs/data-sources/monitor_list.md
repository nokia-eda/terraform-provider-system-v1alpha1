...
- `utilization` (Attributes) Parameters relating to disk utilization monitoring. (see [below for nested schema](#nestedatt--items--spec--disk--utilization))

<a id="nestedatt--items--spec--disk--utilization"></a>
### Nested Schema for `items.spec.disk.utilization`
