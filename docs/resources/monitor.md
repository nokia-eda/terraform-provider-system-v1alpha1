...
- `utilization` (Attributes) Parameters relating to disk utilization monitoring. (see [below for nested schema](#nestedatt--spec--disk--utilization))

<a id="nestedatt--spec--disk--utilization"></a>
### Nested Schema for `spec.disk.utilization`
