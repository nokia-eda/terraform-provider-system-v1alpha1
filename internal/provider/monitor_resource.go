...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-system/internal/resource_monitor"
	"github.com/nokia/eda/apps/terraform-provider-system/internal/tfutils"
)

const (
	create_rs_monitor = "/apps/system.eda.nokia.com/v1alpha1/namespaces/{namespace}/monitors"
	read_rs_monitor   = "/apps/system.eda.nokia.com/v1alpha1/namespaces/{namespace}/monitors/{name}"
	update_rs_monitor = "/apps/system.eda.nokia.com/v1alpha1/namespaces/{namespace}/monitors/{name}"
	delete_rs_monitor = "/apps/system.eda.nokia.com/v1alpha1/namespaces/{namespace}/monitors/{name}"
)
...
func (r *monitorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_monitor, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_monitor, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_monitor,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *monitorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_monitor, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *monitorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_monitor, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
