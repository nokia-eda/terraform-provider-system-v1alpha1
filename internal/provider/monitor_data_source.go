...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-system/internal/datasource_monitor"
...
const read_ds_monitor = "/apps/system.eda.nokia.com/v1alpha1/namespaces/{namespace}/monitors/{name}"
...
func (d *monitorDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_monitor, map[string]string{
...
func (r *monitorDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
