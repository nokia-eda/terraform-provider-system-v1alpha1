...
package resource_monitor_aggregate_state
...
func MonitorAggregateStateResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^MonitorAggregateState$"), ""),
				},
				Default: stringdefault.StaticString("MonitorAggregateState"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the MonitorAggregateState",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"nodes": schema.ListAttribute{
						...
						MarkdownDescription: "List of TopoNodes monitored by this instance",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "MonitorAggregateStateSpec defines the desired state of MonitorAggregateState",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MonitorAggregateStateStatus defines the observed state of MonitorAggregateState",
			},
		},
	}
}

type MonitorAggregateStateModel struct {
