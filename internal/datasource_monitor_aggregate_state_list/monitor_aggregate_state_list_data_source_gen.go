...
package datasource_monitor_aggregate_state_list
...
func MonitorAggregateStateListDataSourceSchema(ctx context.Context) schema.Schema {
...
type MonitorAggregateStateListModel struct {
